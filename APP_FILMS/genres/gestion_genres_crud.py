        ...
        try:
            ...
            with MaBaseDeDonnee().connexion_bd.cursor() as mc_afficher:
                if order_by == "ASC" and id_collaborateur_sel == 0:
                    ...
                    valeur_id_collaborateur_selected_dictionnaire = {"value_id_collaborateur_selected": id_collaborateur_sel}
...
def genre_update_wtf():
    ...
    try:
        ...
        if form_update.validate_on_submit():
            ...
            valeur_update_dictionnaire = {"value_id_collaborateur": id_collaborateur_update, "value_name_collaborateur": name_collaborateur_update, "value_prenom_collaborateur": prenom_collaborateur_update}
